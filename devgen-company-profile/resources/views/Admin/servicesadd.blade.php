        ...
        <div class="card-body">
            <form action="" method="post">
                <div class="col-lg-6">
                    ...
                    <div class="mb-3 row">
                        <label for="example-datetime-local-input" class="col-sm-2 col-form-label text-end">Date and
                            time</label>
                        <div class="col-sm-10">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <input type="color" class="form-control form-control-color" id="exampleColorInput"
                                value="#0b51b7" title="project your color" />
                        </div>
                    </div>
                    <div class="mb-3 row">
                    ...
                    <a href="{{ route('team_admin') }}" class="btn btn-success mt-4" style="margin-left: 45px"><i
                            class="ti ti-check"></i> Save</a>
